...
function Test() {
    ...
    const { width, height, background, borRadius } = useSelector(state => state.box)
    ...
    return (
        ...
        <Nav />
            <div className='grid p-5 mx-auto text-center text-base font-semibold'>
                ...
                <div style={{ width: width, height: height, backgroundColor: background, borderRadius:`${borRadius}px`}} className='grid m-auto border-2 border-gray-900 text-gray-600 place-items-center'>Box</div>
                <div className='m-5'>
                ...
                <div className='mt-2 flex justify-center items-center gap-3 '>
                    ...
                    <input type="range" defaultValue='0' onChange={(e) => dispatch(changeRadius(e.target.value))}
