    ...
    <div>
      ...
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-5 md:flex-row flex-col items-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
            <img className="object-cover object-center rounded" alt="hero" src="poster.png" />
          </div>
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font font-bold sm:text-4xl text-3xl mb-4 text-red-600">Delivery, Reliable and Discover</h1>
            <p className="mb-8 leading-relaxed">Delivering on your business day.</p>
      ...
      <div className="bg-white">
        <div className="mx-auto max-w-7xl py-10 sm:px-6 sm:py-20 lg:px-8">
          <div className="relative isolate overflow-hidden bg-white px-6 pt-10 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-800">Ac euismod vel sit maecenas id pellentesque eu sed consectetur. Malesuada adipiscing sagittis vel nulla.</p>
              <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                <a href="#" className="rounded-md border-2 px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm duration-300 hover:bg-red-500 hover:text-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Get started</a>
                <a href="#" className="text-sm font-semibold leading-6 text-white">Learn more <span aria-hidden="true">→</span></a>
              </div>
            </div>
            <div className="relative mt-16 h-80 lg:mt-8">
              <img className=" rounded-lg " src="poster2.jpg" alt="App screenshot" width="1000" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex h-40 items-center justify-center space-x-5">
        <div x-data="{ tooltip: 'This is a tooltip.' }">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="h-6 w-6 cursor-pointer text-secondary-500" x-tooltip="tooltip">
