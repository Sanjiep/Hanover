                ...
                <div className="p-4 sm:p-7">
                  ...
                  <div className="mt-5">
                    ...
                    <form>
                      ...
                      <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <input type="text" placeholder='First name' id="text" name="firstName" className="py-3 px-4 block capitalize w-full border-gray-200 border-1 rounded-lg text-sm focus:border-red-500 focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required />
                          </div>
                        </div>
                        <div>
                          <label htmlFor="lastName" className="block text-sm mb-2 dark:text-white">Last name</label>
                          <div className="relative">
                            <input type="text" placeholder='Last Name' id="text" name="lastName" className="py-3 px-4 capitalize block w-full border-gray-200 border-1 rounded-lg text-sm focus:border-red-500 focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required />
                          </div>
                        </div>
                        ...
                        {/* <div>
                          ...
                          <div className="relative">
                            <input type="email" placeholder='Email' id="email" name="email" className="py-3 px-4 block w-full border-gray-200 border-1 rounded-lg text-sm focus:border-red-500 focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="password-error" />
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <input type="number" placeholder='Phone number' id="phoneNumber" name="phoneNumber" className="py-3 px-4 block appearance-none w-full border-gray-200 border-1 rounded-lg text-sm focus:border-red-500 focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="phoneNumber-error" />
                          </div>
                        </div>
                      ...
                      <div className="grid gap-y-4 pt-3">
                        ...
                        <div className='relative'>
                          ...
                          <div className="flex items-center">
                            ...
                            <input placeholder='Confirm your password' label="confirmPassword" id="confirmPassword" name="confirmPassword" className={`py-3 px-4 block w-full border-gray-200 border-1 rounded-lg text-sm focus:border-gray-500 focus:ring-gray-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600 ${ isVisible ? 'text-black' : null}`} required aria-describedby="confirmPassword-error" type={isVisible ? 'text' : 'password'}
                              />
                                <button className="focus:outline-none absolute right-4" type="button" onClick={toggleVisibility}>
                                  {isVisible ? (
                                    <svg className="text-2xl opacity-80 text-default-400 pointer-events-none" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <p className="hidden text-xs text-red-600 mt-2" id="confirmPassword-error">Password does not match the password</p>
                        </div>
